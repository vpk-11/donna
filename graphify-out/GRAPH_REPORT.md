...
## Corpus Check
- 70 files · ~20,715 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 374 nodes · 1306 edges · 30 communities (26 shown, 4 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 59 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0d2e3a1a`
...
- `ClientAgent` --uses--> `ConversationSummary`  [INFERRED]
  orchestrator/agent.py → models/orm.py
...
Cohesion: 0.11
Nodes (37): Base, Client, _create_and_greet_client(), handle_new_client_intro(), handle_new_client_intro_clarification(), _check_client_status(), _check_schedule(), handle_admin() (+29 more)

### Community 2 - "Community 2"
Cohesion: 0.10
Nodes (35): BaseModel, BaseSettings, Config, Settings, Exception, scan_input(), scan_output(), build_context_from_summary() (+27 more)
...
Cohesion: 0.26
Nodes (9): datetime, IntentResult, ClientAgent, ClientStore, ConversationStore, datetime, Session, SessionStore (+1 more)

### Community 7 - "Community 7"
Cohesion: 0.12
Nodes (19): Any, Conversation History Ring Buffer, handle_cold_inbound(), route_message(), ConversationState, ConversationStore, Clear pending state but preserve history and protected keys (prefixed _)., Append a turn to conversation history. role is 'user' or 'donna'. (+11 more)
...
Cohesion: 0.14
Nodes (13): 1. Create the environment, 2. Start Redis, 3. Start an LLM, 4. Set environment variables, 5. Run it, 6. Seed test data, Architecture, Config (+5 more)

### Community 20 - "Community 20"
Cohesion: 0.11
Nodes (20): Base, engine, init_db(), get_async_redis(), get_redis(), ping_redis(), ConversationSummary, Mark handoff_active in the Redis agent registry, if the phone is registered. (+12 more)

### Community 22 - "Community 22"
Cohesion: 0.10
Nodes (39): Scheduling Conflict Resolution Strategy, load_business_config(), Load config/business.json once, cache in-process. Static file, no     conversati, SessionArchive, ConflictResult, datetime, resolve_slot(), cancel_day() (+31 more)

## Knowledge Gaps
- **17 isolated node(s):** `Architecture`, `1. Create the environment`, `2. Start Redis`, `3. Start an LLM`, `4. Set environment variables` (+12 more)
...
- **Why does `ConversationStore` connect `Community 7` to `Community 0`, `Admin Intent Dispatch`, `Community 2`, `Messaging Abstraction Layer`, `Community 5`, `Community 20`, `Community 22`?**
  _High betweenness centrality (0.160) - this node is a cross-community bridge._
- **Why does `ClientStore` connect `Community 0` to `Admin Intent Dispatch`, `Community 2`, `Messaging Abstraction Layer`, `Community 5`, `Community 7`, `Community 8`, `Community 20`, `Community 22`?**
